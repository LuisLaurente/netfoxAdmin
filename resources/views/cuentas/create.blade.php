                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('plataforma') is-invalid @enderror" 
                               id="plataforma" name="plataforma" value="{{ old('plataforma') }}">
                        @error('plataforma')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('perfil') is-invalid @enderror" 
                               id="perfil" name="perfil" value="{{ old('perfil') }}">
                        @error('perfil')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('contraseña') is-invalid @enderror" 
                               id="contraseña" name="contraseña" value="{{ old('contraseña') }}">
                        @error('contraseña')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-check mt-4">
                            <input class="form-check-input" type="checkbox" id="alerta_vencimiento" 
                                   name="alerta_vencimiento" value="1" {{ old('alerta_vencimiento') ? 'checked' : '' }}>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control @error('vencimiento_cuenta') is-invalid @enderror" 
                               id="vencimiento_cuenta" name="vencimiento_cuenta" value="{{ old('vencimiento_cuenta') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-check mt-4">
                            <input class="form-check-input" type="checkbox" id="alerta_cuenta" 
                                   name="alerta_cuenta" value="1" {{ old('alerta_cuenta') ? 'checked' : '' }}>
